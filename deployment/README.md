...
### Step 2
Search and Click `All G and VT Spot Instance Requests`.
...
### Step 4
Click on `Request quota increase` and request the appropriate 4 vCPU units.
...
```bash
ssh -i "llm-trainer.pem" ubuntu@<PUBLIC_IP>
```
